 ...
 * @param {Uint8Array} witness_js
 * @returns {string}
 */
export function single_fold(r1cs_bytes, witness_js) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passArray8ToWasm0(r1cs_bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.single_fold(ptr0, len0, witness_js);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_alert_31a9b88219974a3a = function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('sonobe_wasm_browser_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
